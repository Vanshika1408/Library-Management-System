...
//	contentPane.add(l5);
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] { "CSE", "Mechanical",  "Chemical", "Civil", "Electrical", "Aerospace", "Other" }));
...
//	contentPane.add(comboBox_1);
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] { "B.E", "B.Tech", "M.Tech", "MBA",  "B.Sc", "M.Sc", "B.Com", "M.Com" }));
